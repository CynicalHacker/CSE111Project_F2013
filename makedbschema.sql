...
CREATE TABLE inventory (i_amount decimal(7,0) not null, i_unit char (1) not null,  i_cname varchar not null, i_casn decimal(10,0) not null);
...
--Create triggers for empty inventory--
